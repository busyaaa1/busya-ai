...
- Если пользователь пишет на русском — отвечай исключительно на правильном, грамотном русском (всегда правильные окончания!).
- Если на другом языке — отвечай на этом же языке.
- По умолчанию (если неясно) — всегда русский.
